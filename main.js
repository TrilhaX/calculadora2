...
(_b = document.querySelector("#calcularButton")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", Outros.mostrarResultado);
(_c = document.getElementById("mostrarCalculo")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", Outros.mostrarConta);
(_d = document.getElementById("mostrarHistorico")) === null || _d === void 0 ? void 0 : _d.addEventListener("click", Outros.mostrarHistorico);
(_f = document.getElementById("calcularButton")) === null || _f === void 0 ? void 0 : _f.addEventListener("click", Outros.updateConta);
(_g = document.querySelector("#deletarResult")) === null || _g === void 0 ? void 0 : _g.addEventListener("click", Outros.deleteResultado);
(_h = document.querySelector(".clearHistory")) === null || _h === void 0 ? void 0 : _h.addEventListener("click", Historico.clearHistory);
(_j = document.getElementById('dropdownCalculos')) === null || _j === void 0 ? void 0 : _j.addEventListener('click', function () {
...
(_k = document.getElementById("tipoProgressão-select")) === null || _k === void 0 ? void 0 : _k.addEventListener("change", function () {
...
(_l = document.getElementById("tipoPA-select")) === null || _l === void 0 ? void 0 : _l.addEventListener("change", function () {
...
(_m = document.getElementById("tipoPG-select")) === null || _m === void 0 ? void 0 : _m.addEventListener("change", function () {
...
(_o = document.getElementById("matriz-select")) === null || _o === void 0 ? void 0 : _o.addEventListener("change", () => {
